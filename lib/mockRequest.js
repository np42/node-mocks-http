...
function createRequest(options) {
    ...
    //add compatibility to cookie-parser module
    mockRequest.connection = { encrypted: /^https:/.test(mockRequest.url) };
    mockRequest._headers = {};
    mockRequest._headerNames = {};
    mockRequest._removedHeader = {};
